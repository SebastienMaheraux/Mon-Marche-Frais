...
<?php 
    ...
    $reponse = $bdd->query('SELECT * FROM article WHERE id_category=2 ');
...
<label for="type"></label><input type="hidden" name="id_category" id="id_category" value="2"/>
<label for="name"></label><input placeholder="Nom legume ( ex : Tomate)"type="text" name="name" id="name"/><br/>
